...
const Filter = () => {
  return (
    <div className='mt-8 flex flex-col lg:flex-row justify-between items-center p-4 rounded-lg bg-gray-100 drop-shadow-sm'>
        ...
        <div className='flex justify-around items-center w-full  lg:w-1/5 ml-7 text-blue-900 '>
            <button className='flex items-center justify-around bg-white max-w-xs  px-3 py-2 rounded-lg font-semibold drop-shadow-md mr-1'>
                <FilterIcon className='w-5 h-5 mr-2'/>
                Filters
            </button>
            <button className='flex items-center justify-around bg-white max-w-xs  px-3 py-2 rounded-lg font-semibold drop-shadow-md'>
